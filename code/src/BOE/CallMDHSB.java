...
public class CallMDHSB {
    public static void main(String[] args) {
        try {
            ...
            // 原始字符串
            String data = "_api_access_key=ak&_api_name=service&_api_nonce=2FDC553E-467F-444F-9C35-802FF7936C68&_api_timestamp=1559467961208&_api_version=1.0&action=" + action + "&message=" + message;
